...
Cupid.settings = {
	client: window.__THIS.CONF.cupid.client,
	clientSlug: window.__THIS.CONF.cupid.clientSlug,
	sourceMedium: window.__THIS.CONF.cupid.sourceMedium,
	cupidApiEndpoint: window.__THIS.CONF.cupid.cupidApiEndpoint,
	trackingURL: window.__THIS.CONF.trackingURL,
	authCookieName: window.__THIS.CONF.cupid.authCookieName,
	forceLogoutIfLoggedInBefore: new Date( window.__THIS.CONF.cupid.forceLogoutIfLoggedInBefore )
};
